    ...
    try {
      ...
      switch (post.type) {
        ...
        case 'press':
          ...
          break;
        case 'brand-story':
          endpoint = `/api/brand-story/${post.slug}`;
          break;
        default:
          return;
      }
      ...
      if (response.ok) {
        ...
        switch (post.type) {
          ...
          case 'brand-story':
            // 브랜드 스토리 데이터 구조 정규화
            const brandStoryData = data.brandStory || data;
            normalizedData = {
              slug: brandStoryData.slug,
              content: {
                ko: {
                  title: brandStoryData.content?.ko?.title || '',
                  subtitle: brandStoryData.content?.ko?.subtitle || '',
                  body: brandStoryData.content?.ko?.body || '',
                  thumbnail_url: brandStoryData.content?.ko?.thumbnail_url || '',
                  images: brandStoryData.content?.ko?.images || []
                },
                en: {
                  title: brandStoryData.content?.en?.title || '',
                  subtitle: brandStoryData.content?.en?.subtitle || '',
                  body: brandStoryData.content?.en?.body || '',
                  thumbnail_url: brandStoryData.content?.en?.thumbnail_url || '',
                  images: brandStoryData.content?.en?.images || []
                }
              },
              tags: brandStoryData.tags?.join(', ') || '',
              youtube_url: brandStoryData.youtube_url
            };
            break;
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-7xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="p-6">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow max-w-sm mx-auto">
                        ...
                        <div className="p-4">
                          {/* 브랜드 스토리 유튜브 표시 */}
                          {post.type === 'brand-story' && postData.youtube_url && (
                            <div className="mb-3">
            ...
            <div className="mt-8 flex justify-end space-x-3">
              ...
              <a
                href={`/admin/${post.type === 'blog' ? 'blog' : post.type === 'press' ? 'press' : 'brand-story'}/${post.slug}/edit`}
